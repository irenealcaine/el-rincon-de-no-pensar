...
const accents = [
  ...
  { bg: "bg-amber-400/20", icon: "text-amber-600", dot: "bg-amber-500" },
        ...
        return (
          ...
          >
            <div className="relative flex aspect-[4/3] flex-col items-center justify-center gap-4 rounded-2xl border-2 border-ink/10 bg-white p-6 shadow-card transition-all duration-300 hover:-translate-y-1.5 hover:border-ink/20 hover:shadow-lift">
              ...
              />
              <span className="absolute left-4 top-3 font-oswald text-xs font-bold uppercase tracking-widest text-ink/20">
              ...
              <span className="mt-1 inline-flex items-center gap-1.5 font-bold text-xs uppercase tracking-widest text-ink/40 transition-all duration-300 group-hover:gap-3 group-hover:text-clay">
                Entrar
